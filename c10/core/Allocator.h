...
class C10_API DataPtr {
 private:
  ...
  // TODO: NOTE: DataPtr actually binds (data and its context) and (data's device)
 ...
 public:
  ...
  void* operator->() const {
    return ptr_.get();  // TODO: NOTE: get a pointer to data
  }
  void clear() {
    ptr_.clear();
  }
  ...
  void* get_context() const {
    return ptr_.get_context();  // TODO: NOTE: get a pointer to context
  }
  ...
  // TODO: NOTE: is it unsafe because normally we construct an DataPtr with device when initialization.
